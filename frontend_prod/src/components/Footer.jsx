...
<footer class="bg-zinc-800  w-full ">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between gap-10">
          <div class="mb-6 md:mb-0">
              <a class="flex items-center">
                  <span class="self-center text-3xl font-semibold poppins whitespace-nowrap text-violet-400">ChargeVolt</span>
              </a>
              <p className=' mt-4 md:mt-16 text-xl text-white'>New Building,<br />JNTU College,Kukatpally <br /> Hyderabad,Telangana 500085</p>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="" class="hover:underline">ChargeVolt™</a> All Right Reserved.
