                ...
                <div  className=' w-full col-span-1 flex-box justify-end '>
                    <div className=' relative group '>
                        ...
                        <div className=' absolute flex-box  invisible opacity-0 flex-col gap-2 p-2 bg-violet-200 top-10 -right-5 text-violet-900 group-hover:visible group-hover:opacity-100 duration-300 text-md font-[600] rounded-xl'>
                            <Link className='flex-box justify-start w-full  gap-2 hover:text-violet-100 hover:bg-violet-400 p-3 duration-150 w-full rounded-xl'><User size={25} />Profile</Link>
                            <Link className='flex-box justify-start w-full  gap-2 hover:text-violet-100 hover:bg-violet-400 p-3 duration-150 w-full rounded-xl'><Car size={25} />Vehicles</Link>
                            <Link className='flex-box justify-start w-full  gap-2 hover:text-violet-100 hover:bg-violet-400 p-3 duration-150 w-full rounded-xl'><ShoppingBag size={25} />Bookings</Link>
                            <button
