    ...
    return (
        <section className="w-full flex-box flex-col">
            <div className="w-full h-[100vh] flex-box bg-black relative overflow-hidden text-white">
                ...
                <motion.div variants={container} initial="hidden" animate="visible"  className="z-10 w-full h-full flex-box justify-start mt-[20%] flex-col gap-5">

                    <AnimatedWordText text={"Charge your EV"} style={' text-4xl font-bold  text-white/85'}/>
                    
                    <motion.h1 initial={{y:500}} animate={{y:0}} transition={{duration:1.5,ease:"easeInOut",type:"tween"}} className=" text-8xl font-bold  bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-amber-200 via-violet-600 to-sky-900 text-transparent bg-clip-text ">
                    Hassle Free
                    </motion.h1>

                    <AnimatedWordText text={"Secure Your Exclusive Slot Today!"} style={'text-sm font-light'} />
            ...
            <div className=" w-full  flex-box flex-col bg-[#f8f1ff] relative">
                ...
                <div className=" w-[75%] flex-box flex-col p-3 mt-[15rem] relative">
                    ...
                    <div className=" w-3/4 z-20 self-start flex-box flex-col gap-2 items-start ">
                        <h1 className=" text-xl font-semibold text-violet-600  ">About</h1>
                        <h1 className=" relative text-2xl font-bold lg:small-title drop-shadow-lg">Charge Your EV With No Queue:<br />Our Vision for a 
                        <span className=" text-teal-400 relative"> Greener 
                        <img
                            src={wave}
                            alt="background"
                            ...
                            draggable={false}
                        /></span> Future</h1>
                        <p className=" mt-5 leading-[1.5em] font-medium">Experience the ease of charging your electric vehicle with our seamless solutions. From fast charging options to user-friendly interfaces, our systems are designed to simplify your charging experience. Say goodbye to range anxiety and hello to hassle-free journeys, making every charge convenient and efficient.</p>
            ...
            <div className=" w-full flex-box flex-col justify-start bg-[#f8f1ff] relative ">
                <div className=" z-10 w-3/4 h-full flex-box justify-evenly flex-col ">
                    ...
                    <motion.div initial={{opacity:0,y:200,x:30,clipPath: "inset(0% 100% 0% 0%)"}} whileInView={{opacity:1,y:0,x:0,clipPath: "inset(0% 0% 0% 0%)"}} transition={{delay:0.5,duration:1.5,type:"spring"}} className=" w-3/4 z-20  flex-box flex-col gap-2  mt-[10rem] ">
                        <h1 className=" relative small-title  ">Why Choose <span className=" text-violet-500">SparkCharge</span>?</h1>
                    </motion.div>

                    <motion.div transition={{staggerChildren:0.04,delayChildren:1}}  className=" w-[90%] grid grid-cols-3 gap-10 mt-[10rem]">



                        <motion.div  initial={{opacity:0,y:200}} whileInView={{opacity:1,y:0,x:0}} transition={{delay:0.5,duration:1.5,type:"spring"}}  className="w-full h-[18rem] flex-box flex-col justify-center items-start p-[2em] relative  bg-violet-200  col-span-1 rounded-3xl shadow-lg bg-gradient-to-r from-indigo-300 to-purple-400">
                            <div className=" p-4 flex-box absolute top-[-5%] right-[-5%] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-purple-400 via-purple-500 to-purple-700 shadow-md shadow-yellow-400 drop-shadow-xl  hover:shadow-xl group hover:scale-90 duration-200 rounded-full">
                                <Zap className=" text-yellow-300 group-hover:text-white group-hover:animate-pulse group-hover:rotate-180 duration-300 " size={50} />
                            </div>
                            
                            <h1 className=" text-6xl font-bold text-white">Prioritize Fast Charge</h1>
                        </motion.div>


                        <motion.div initial={{opacity:0,y:200}} whileInView={{opacity:1,y:0,x:0}} transition={{delay:0.5,duration:1.5,type:"spring"}} className="w-full h-[18rem] flex-box flex-col justify-center  p-10 relative  bg-violet-200 col-span-1 rounded-3xl ">
                            <div className=" p-4 flex-box absolute top-[-5%] right-[-5%] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-purple-400 via-purple-500 to-purple-700  shadow-md shadow-rose-300 drop-shadow-xl hover:shadow-xl group hover:scale-90 duration-200 rounded-full">
                                <TimerOff className="  text-white/80 group-hover:text-white group-hover:scale-[0.8] duration-300 " size={50} />
                            </div>
                            <h1 className=" text-6xl font-bold text-violet-500">No Waiting Time</h1>
                        </motion.div>
                        

                        <motion.div initial={{opacity:0,y:200}} whileInView={{opacity:1,y:0,x:0}} transition={{delay:0.5,duration:1.5,type:"spring"}} className="w-full h-[18rem] flex-box flex-col justify-center items-start p-10 relative  bg-violet-200 col-span-1 rounded-3xl shadow-lg bg-gradient-to-r from-indigo-300 to-purple-400">
                            <div className=" p-4 flex-box absolute top-[-5%] right-[-5%] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-purple-400 via-purple-500 to-purple-700 shadow-md shadow-cyan-300 drop-shadow-xl overflow-hidden  hover:shadow-xl group hover:scale-90 duration-200 rounded-full">
                                <Car className=" text-cyan-300 group-hover:text-white group-hover:animate-pulse group-hover:translate-x-[100px]  duration-300 " size={50} />
                            </div>
                            <h1 className=" text-6xl font-bold text-white">Pickup And Drop Service</h1>
                        </motion.div>
