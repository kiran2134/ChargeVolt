...
import { useToggler } from '../hooks/customStates';
...
const UserProfile = () => {
    ...
    const [isBoxOpen,setIsBoxOpen] = useToggler(false); 
                ...
                <div className=" w-3/4 h-[85%] grid grid-cols-5 mt-[2em]  bg-[#f3e9ffc5] dark:bg-[#eaddffdf] backdrop-blur-md rounded-2xl shadow-2xl shadow-violet-300 p-4">
                    ...
                    <div className="col-span-4 w-full h-full flex-container overflow-y-auto no-scrollbar gap-10 justify-start p-10">
                        <ProfileContainer>
                            <div
                                ref={ProfileRef}
                                className="  flex-box flex-col gap-1  items-start  "
                            >
                                <Title text={"Profile"} />
                                ...
                                {isBoxOpen ? (
                                    <Form className=" w-full flex-box gap-2 ">
                                        ...
                                        <input
                                            type="text"
                                            value={
                                                newVehicleData.registrationNum
                                            }
                                            onChange={(e) =>
                                                setNewVehicleData({
                                                    ...newVehicleData,
                        ...
                        <ProfileContainer>
                            ...
                            <UserProfileInfo>
                                ...
                                <button onClick={()=>setIsOpen(!isOpen)} className=" p-2 flex-box gap-1 bg-violet-900  group-hover:visible  text-violet-200 text-[0.7rem]  rounded-lg">
                                    Reset Password
                                </button>
                            </UserProfileInfo>
