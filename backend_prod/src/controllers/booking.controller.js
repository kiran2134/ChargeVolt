...
const reserve = asyncHandler(async (req, res, next) => {
    const {stationName, slotType, bookingDate, selectedDate, bookingTime, registrationNumber} = req.body
    console.log("at 20  "+JSON.stringify(req.body));
